...
def resnet34(output_layers=None, pretrained=False, **kwargs):
    ...
    model = ResNet(BasicBlock, [3, 4, 6, 3], output_layers, **kwargs)
    if pretrained:
...
def resnet152(output_layers=None, pretrained=False, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 8, 36, 3], output_layers, **kwargs)
    if pretrained:
