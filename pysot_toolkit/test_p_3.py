...
def main():
    ...
    net_path = '/home/cx/cx1/work_dir/work_dir_mt_2t_e464_iouh_loss/checkpoints/ltr/transt/transt_iouh_ddp/TransTiouh_ep0090.pth.tar'
    ...
    for i in range(10000):
        ut = random.randint(850,940)
        w = random.randint(300,700)
        name = 'loss1e464e90'+'_w'+str(w)+'_ut'+str(ut)
        ut = ut/1000
        w = w/1000
