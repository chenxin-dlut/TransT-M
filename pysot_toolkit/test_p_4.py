...
def main():
    ...
    net_path = '/home/cx/cx1/work_dir/work_dir_mt_2t_e464_iouh_loss_2/checkpoints/ltr/transt/transt_iouh_ddp/TransTiouh_ep0090.pth.tar'
    ...
    for i in range(10000):
        ut = random.randint(810,910)
        w = random.randint(300,700)
        name = 'loss2e464e90'+'_w'+str(w)+'_ut'+str(ut)
        ut = ut/1000
        w = w/1000
        tracker = Tracker(name=name, net=net, mask=args.mask,
                          window_penalty=w, penalty_k=0, iou_alpha=0,
                          update_threshold=ut, exemplar_size=128, instance_size=256)
