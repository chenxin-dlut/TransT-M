...
def main():
    ...
    dataset_root = '/home/cx/cx2/Downloads/UAV123/UAV123_fix/Dataset_UAV123/UAV123/data_seq/UAV123'  # path to uav
    ...
    tracker = Tracker(name='transt-m', net=net, mask=args.mask,
                      ...
                      update_threshold=0.95, exemplar_size=128, instance_size=256)
